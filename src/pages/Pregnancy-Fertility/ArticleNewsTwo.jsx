...
// import { PFarticleContentsTwoTwo } from './data/PFarticles';
// import SubscriptionForm from '../../components/FriskyComponent';

// const PFArticleNewsTwo = () => {
//   const { slug } = useParams();
//   const [article, setArticle] = useState(null);

//   useEffect(() => {
//     const load = async () => {
//       const data = PFarticleContentsTwo[slug];
...
//         <Link to="/PFarticles-two" className="text-blue-500 hover:underline">
...
// export default PFArticleNewsTwo;
...
// export default PFArticleNews;
import { useState, useEffect } from 'react';
import { useParams, Link } from 'react-router-dom';
import { PFarticleContentsTwo } from './data/PFarticles';
import SubscriptionForm from '../../components/FriskyComponent';
...
const handleFeedbackClick = (type) => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !PFarticleContentsTwo[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(PFarticleContentsTwo[cleanSlug]);
    };
    load();
  }, [slug]);
    ...
    <>
      <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="px-6 pt-6 pb-2">
          <Link to="/pregnancy-and-fertility" className="text-[#058e8d] hover:underline text-sm font-medium">
             Sexual health  wellness &gt; Pregnancy And Fertility &gt; &gt;
          </Link>
        </div>
...
<div className="px-6 py-6">
  <div
    className=" text-md prose prose-lg max-w-none prose-b:text-3xl prose-b:font-bold prose-b:text-gray-900 prose-p:leading-relaxed prose-p:mb-4 prose-a:text-blue-600 prose-a:hover:text-blue-800 pros-b:text-3xl"
  ...
  />
         ...
         {/* Feedback Section - Add this where you want it */}
