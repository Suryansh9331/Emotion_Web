...
import { ActivismAndPoliticsarticleContents } from "./data/articles";
import SubscriptionForm from "../../../components/FriskyComponent";

// const ActivismAndPoliticsArticleNews = () => {
...
//       const data = ActivismAndPoliticsarticleContents[slug];
...
//       <Link to="/ActivismAndPoliticsarticles" className="text-blue-500 hover:underline">&larr; Back to all articles</Link>
...
//   );
// };
// export default ActivismAndPoliticsArticleNews;
...
const ActivismAndPoliticsArticleNews = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !ActivismAndPoliticsarticleContents[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(ActivismAndPoliticsarticleContents[cleanSlug]);
    };
    load();
  }, [slug]);
    ...
    <>
      <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="px-6 pt-6 pb-2">
          <Link
            to="/lifestyle-and-inspiration/activism-politics"
        ...
        {PFarticle.showSocialIcons && (
          <div className="px-6 py-4">
            <div className="flex items-center space-x-2">
              ...
              >
                <svg className="w-14 h-14" viewBox="0 0 26 26" fill="#028388">
