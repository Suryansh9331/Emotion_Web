...
import { HoroscopearticleContentsTwo } from "./data/articles";
import SubscriptionForm from "../../../components/FriskyComponent";

// const HoroscopeArticleNewsTwo = () => {
//   const { slug } = useParams();
//   const [article, setArticle] = useState(null);

//   useEffect(() => {
//     const load = async () => {
//       const data = HoroscopearticleContentsTwo[slug];
...
//         <Link to="/Horoscopearticles-two" className="text-blue-500 hover:underline">
...
// export default HoroscopeArticleNewsTwo;
...
const HoroscopeArticleNewsTwo = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !HoroscopearticleContentsTwo[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(HoroscopearticleContentsTwo[cleanSlug]);
    };
    load();
  }, [slug]);
