...
import { Link } from 'react-router-dom';
import { HoroscopearticlesTwo } from './data/articles';
...
const HoroscopeArticlesLayoutTwo = () => (
  <div className="min-h-screen bg-[#f5f5f5] py-8">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="space-y-0">
        {HoroscopearticlesTwo.map(article => (
          <Link
            key={article.slug}
            to={`/lifestyle-and-inspiration/horoscopes/articles-two/${article.slug}`}
          >
            <ArticleCard {...article} />
          </Link>
        ))}
...
export default HoroscopeArticlesLayoutTwo;
