        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-12 max-w-3xl mx-auto" >
            <p className="text-sm text-gray-600 leading-relaxed">
              Bedsider lists these resources for your convenience, but we don't get to visit each provider or health center, so 
              we can't make any endorsements or recommendations. Please use your best judgment when making any health 
              care decisions. In order to be included in the Bedsider clinic finder, the office or clinic must counsel on or refer 
