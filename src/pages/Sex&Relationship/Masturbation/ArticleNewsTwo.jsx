...
import { MBarticleContentsTwo } from './data/articles';
import SubscriptionForm from "../../../components/FriskyComponent";

// const MBArticleNewsTwo = () => {
//   const { slug } = useParams();
//   const [article, setArticle] = useState(null);

//   useEffect(() => {
//     const load = async () => {
//       const data = MBarticleContentsTwo[slug];
...
//         <Link to="/MBarticles-two" className="text-blue-500 hover:underline">
...
// export default MBArticleNewsTwo;
...
const handleFeedbackClick = (type) => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !MBarticleContentsTwo[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(MBarticleContentsTwo[cleanSlug]);
    };
    load();
  }, [slug]);
