      ...
      <div className="bg-white py-4 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-center text-sm text-gray-600">
            ...
            <span className="text-gray-500">Boundaries & consent</span>
          </div>
        </div>
      </div>
