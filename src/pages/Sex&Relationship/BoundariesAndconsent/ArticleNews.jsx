...
import { BACarticleContents } from "./data/articles";
import SubscriptionForm from "../../../components/FriskyComponent";

// const BACArticleNews = () => {
...
//       const data = BACarticleContents[slug];
...
//       <Link to="/BACarticles" className="text-blue-500 hover:underline">&larr; Back to all articles</Link>
...
const BACArticleNews = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !BACarticleContents[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(BACarticleContents[cleanSlug]);
    };
    load();
  }, [slug]);
    ...
    <>
      <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="px-6 pt-6 pb-2">
          <Link
            to="/sex-relationships/BoundariesAndconsent/articles"
            className="text-[#058e8d] hover:underline text-sm font-medium"
          >
            Sex & relationships &gt; Boundaries & consent &gt; &gt;
          </Link>
        </div>
        {/* Article Title */}
