...
import { BACarticleContentsTwo } from './data/articles';
import SubscriptionForm from "../../../components/FriskyComponent";

// const BACArticleNewsTwo = () => {
//   const { slug } = useParams();
//   const [article, setArticle] = useState(null);

//   useEffect(() => {
//     const load = async () => {
//       const data = BACarticleContentsTwo[slug];
...
//         <Link to="/BACarticles-two" className="text-blue-500 hover:underline">
...
// export default BACArticleNewsTwo;
...
const handleFeedbackClick = (type) => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !BACarticleContentsTwo[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(BACarticleContentsTwo[cleanSlug]);
    };
    load();
  }, [slug]);
    ...
    <>
     <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="px-6 pt-6 pb-2">
          <Link to="/sex-relationships/BoundariesAndconsent/articles-two" className="text-[#058e8d] hover:underline text-sm font-medium">
