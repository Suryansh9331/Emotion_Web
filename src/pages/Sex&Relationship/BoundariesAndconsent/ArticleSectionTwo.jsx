...
import { Link } from 'react-router-dom';
import { BACarticlesTwo } from './data/articles';
...
const BACArticlesLayoutTwo = () => (
  <div className="min-h-screen bg-gray-50 py-8">
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="space-y-0">
        {BACarticlesTwo.map(article => (
          <Link
            key={article.slug}
            to={`/sex-relationships/BoundariesAndconsent/articles-two/${article.slug}`}
          >
            <ArticleCard {...article} />
          </Link>
        ))}
...
export default BACArticlesLayoutTwo;
