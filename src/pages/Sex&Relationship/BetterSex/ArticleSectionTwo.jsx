...
import { Link } from 'react-router-dom';
import { BSarticlesTwo } from './data/articles';
...
const BSArticlesLayoutTwo = () => (
  <div className="min-h-screen bg-gray-50 py-8">
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="space-y-0">
        {BSarticlesTwo.map(article => (
          <Link
            key={article.slug}
            to={`/sex-relationships/BetterSex/articles-two/${article.slug}`}
          >
            <ArticleCard {...article} />
          </Link>
        ))}
...
export default BSArticlesLayoutTwo;
