...
import { BSarticleContentsTwo } from "./data/articles";
import SubscriptionForm from "../../../components/FriskyComponent";

// const  BSArticleNewsTwo = () => {
//   const { slug } = useParams();
//   const [article, setArticle] = useState(null);

//   useEffect(() => {
//     const load = async () => {
//       const data =   BSarticleContentsTwo[slug];
...
//         <Link to="/  BSarticles-two" className="text-blue-500 hover:underline">
...
// export default   BSArticleNewsTwo;
...
const BSArticleNewsTwo = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !BSarticleContentsTwo[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(BSarticleContentsTwo[cleanSlug]);
    };
    load();
  }, [slug]);
    ...
    <>
      <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="px-6 pt-6 pb-2">
          <Link
            to="/sex-relationships/BetterSex/articles-two"
