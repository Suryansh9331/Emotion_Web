...
import { DAHarticleContents } from "./data/articles";
import SubscriptionForm from "../../../components/FriskyComponent";

// const DAHArticleNews = () => {
...
//       const data = DAHarticleContents[slug];
...
//       <Link to="/DAHarticles" className="text-blue-500 hover:underline">&larr; Back to all articles</Link>
...
const DAHArticleNews = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !DAHarticleContents[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(DAHarticleContents[cleanSlug]);
    };
    load();
  }, [slug]);
    ...
    <>
      <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="px-6 pt-6 pb-2">
          <Link
            to="/sex-relationships/DatingAndHookup/articles"
