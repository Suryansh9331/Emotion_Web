...
import { RSarticleContentsTwo } from "./data/articles";
import SubscriptionForm from "../../../components/FriskyComponent";

// const RSArticleNewsTwo = () => {
//   const { slug } = useParams();
//   const [article, setArticle] = useState(null);

//   useEffect(() => {
//     const load = async () => {
//       const data = RSarticleContentsTwo[slug];
...
//         <Link to="/RSarticles-two" className="text-blue-500 hover:underline">
...
// export default RSArticleNewsTwo;
...
const RSArticleNewsTwo = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !RSarticleContentsTwo[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(RSarticleContentsTwo[cleanSlug]);
    };
    load();
  }, [slug]);
    ...
    <>
      <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="px-6 pt-6 pb-2">
          <Link
            to="/sex-relationships/Relationships/articles-two"
