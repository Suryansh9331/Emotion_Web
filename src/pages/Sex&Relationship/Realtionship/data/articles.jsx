export const RSarticles = [
  {
    ...
    image:
      "/Sex&Relationship/Relationship/Article1.png",
  ...
  },  
  {
    ...
    image:
      "/Sex&Relationship/Relationship/Article2.png",
    hasQuestionPattern: false,
  },
  {
    ...
    subtitle: "Pass it on",
    image:
      "/Sex&Relationship/Relationship/Article3.png",
    hasQuestionPattern: false,
  },
  {
    ...
    image: "/Sex&Relationship/Relationship/Article4.png",
    hasQuestionPattern: false,
  },
  {
    ...
    image: "/Sex&Relationship/Relationship/Article5.png",
    hasQuestionPattern: false,
  },
];    
...
export const RSarticleContents = {
 "how-to-tell-your-provider-that-you-re-polyamorous": {
  ...
  image: "/Sex&Relationship/Relationship/Article1.png",
...
,"sexual-health-services-you-can-get-from-the-comfort-of-your-own-home": {
  ...
  image: "/Sex&Relationship/Relationship/Article2.png",
  showSocialIcons: true,
...
"the-best-tips-we-ve-ever-gotten-from-health-care-providers": {
  ...
  date: "May 05, 2023",
  updated: "",
  image: "/Sex&Relationship/Relationship/Article3.png",
  showSocialIcons: true,
...
export const RSarticlesTwo = [
  {
    ...
    image:
      "/Sex&Relationship/Relationship/Article6.png",
    hasQuestionPattern: false,
  },
  {
    ...
    image:
      "/Sex&Relationship/Relationship/Article7.png",
    hasQuestionPattern: false,
  },
  {
    ...
    image:
      "/Sex&Relationship/Relationship/Article8.png",
    hasQuestionPattern: false,
  },
  
  {
    ...
    image: "/Sex&Relationship/Relationship/Article9.png",
    hasQuestionPattern: false,
  },
{
    ...
    image: "/Sex&Relationship/Relationship/Article10.png",
    hasQuestionPattern: false,
  }
];
...
// Full article contents, keyed by slug
export const RSarticleContentsTwo = {
 "can-i-tell-if-someone-els": {
  ...
  date: "Aug 10, 2021",
  updated: "",
  image: "/Sex&Relationship/Relationship/Article6.png",
  showSocialIcons: true,
...
,
  "is-telehealth-totally-impersonal": {
    ...
    date: "Jun 03, 2021",
    updated: "",
    image: "/Sex&Relationship/Relationship/Article7.png",
    showSocialIcons: true,
...
For more info on telehealth and what it can do for you (think: getting your birth control delivered to your door), here’s an article all about it.`,
  ...
  date: "Nov 21, 2020",
  updated: "",
  image: "/Sex&Relationship/Relationship/Article8.png",
  showSocialIcons: true,
