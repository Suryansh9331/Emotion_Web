...
import { ViewAllarticleContentsTwo } from './data/articles';
import SubscriptionForm from "../../../components/FriskyComponent";

// const ViewAllArticleNewsTwo = () => {
//   const { slug } = useParams();
//   const [article, setArticle] = useState(null);

//   useEffect(() => {
//     const load = async () => {
//       const data = ViewAllarticleContentsTwo[slug];
...
//         <Link to="/ViewAllarticles-two" className="text-blue-500 hover:underline">
...
// export default ViewAllArticleNewsTwo;
...
const handleFeedbackClick = (type) => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !ViewAllarticleContentsTwo[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(ViewAllarticleContentsTwo[cleanSlug]);
    };
    load();
  }, [slug]);
    ...
    <>
     <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="px-6 pt-6 pb-2">
          <Link to="/sex-relationships/VewAll/articles-two" className="text-[#058e8d] hover:underline text-sm font-medium">
