...
import ViewAllArticlesLayout from "./ArticleSection";
import ViewAllArticlesLayoutTwo from "./ArticleSectionTwo";
  ...
  return (
    <div>
      ...
      <div className="relative rounded-lg overflow-hidden min-h-[400px] md:min-h-[600px] flex flex-col justify-center items-center p-8">
        ...
        <img
          src="https://www.Bedsiderr.org/rails/active_storage/representations/redirect/eyJfcmFpbHMiOnsibWVzc2FnZSI6IkJBaHBBcUJyIiwiZXhwIjpudWxsLCJwdXIiOiJibG9iX2lkIn19--0825513c8168fd7db7daf3a915a1b362a3831e6e/eyJfcmFpbHMiOnsibWVzc2FnZSI6IkJBaDdCem9MWm05eWJXRjBPZ2wzWldKd09oTnlaWE5wZW1WZmRHOWZabWxzYkZzSGFRTDRBbWtDa0FFPSIsImV4cCI6bnVsbCwicHVyIjoidmFyaWF0aW9uIn19--a3ab3c05229ad5f0864920d0b6b36ed3f914792c/broken%20heart.jpg"
          alt=""
