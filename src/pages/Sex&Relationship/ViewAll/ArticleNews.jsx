...
import { ViewAllarticleContents } from "./data/articles";
import SubscriptionForm from "../../../components/FriskyComponent";

// const ViewAllArticleNews = () => {
...
//       const data = ViewAllarticleContents[slug];
...
//       <Link to="/ViewAllarticles" className="text-blue-500 hover:underline">&larr; Back to all articles</Link>
...
//   );
// };
// export default ViewAllArticleNews;
...
const ViewAllArticleNews = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !ViewAllarticleContents[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(ViewAllarticleContents[cleanSlug]);
    };
    load();
  }, [slug]);
    ...
    <>
      <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="px-6 pt-6 pb-2">
          <Link
            to="/sex-relationships/VewAll/articles"
