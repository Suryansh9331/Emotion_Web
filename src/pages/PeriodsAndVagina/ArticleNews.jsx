...
import { PVarticleContents } from './data/articles';
...
//       const data = PVarticleContents[slug];
...
//       <Link to="/PVarticles" className="text-blue-500 hover:underline">&larr; Back to all articles</Link>
...
const handleFeedbackClick = (type) => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || ! PVarticleContents[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle( PVarticleContents[cleanSlug]);
    };
    load();
  }, [slug]);
