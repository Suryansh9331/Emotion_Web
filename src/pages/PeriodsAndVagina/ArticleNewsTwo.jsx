...
import { PVarticleContentsTwo } from "./data/articles";
import SubscriptionForm from "../../components/FriskyComponent";

// const PVArticleNewsTwo = () => {
//   const { slug } = useParams();
//   const [article, setArticle] = useState(null);

//   useEffect(() => {
//     const load = async () => {
//       const data = PVarticleContentsTwo[slug];
...
//         <Link to="/PVarticles-two" className="text-blue-500 hover:underline">
...
// export default PVArticleNewsTwo;
...
const PVArticleNewsTwo = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !PVarticleContentsTwo[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(PVarticleContentsTwo[cleanSlug]);
    };
    load();
  }, [slug]);
    ...
    <>
      <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="px-6 pt-6 pb-2">
          ...
          >
            Sexual health wellness &gt; Periods And Vaginal Health &gt; &gt;
          </Link>
        </div>
        {/* Article Title */}
        ...
        <div className="px-4 sm:px-6 py-8">
          <div className="border-t border-gray-200 pt-8">
            ...
            <div className="flex justify-center items-center space-x-8 sm:space-x-12 md:space-x-16 mb-8">
              ...
              >
                <div
                  className={`w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center transition-colors duration-200 ${
