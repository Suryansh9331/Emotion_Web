...
const contentData = {
  title: "The abortion pill: What to expect",
  sections: [
    {
      id: "how-far-pregnancy",
      title: " ",
...
Medication abortion is often called the abortion pill, but in reality, it’s not just one pill. And there are multiple ways to use abortion pills to have an abortion. Depending on availability and other factors, it’s possible to use only one type of medication for a medication abortion, but the most effective and common kind of medication abortion in the U.S. involves taking two different medications.`
  ...
  {
  id: "How does taking the abortion pill work?",
  title: "How does taking the abortion pill work?",
  content: `
<h3 style="font-size: 1.25rem; font-weight: 600;">Step 1: Counseling, maybe an ultrasound, and maybe a waiting period</h3>
<p>First you’ll fill out some paperwork. You’ll talk with a health care provider, and you may have an ultrasound to find out or confirm how far along you are in your pregnancy. If you are further along in pregnancy, then medication abortion may not be an option for you.</p>

<p>If the state where you’re getting your abortion has a <b>mandatory waiting period</b>, you’ll have to wait some number of hours between the counseling appointment and the appointment when you’ll take the first medication. If there is a waiting period, and you are going to have to travel a long way for your abortion, ask if virtual counseling is an option when you call to make your appointment.</p>

<h3 style="font-size: 1.25rem; font-weight: 600;">Step 2: Take the first medication at a health center</h3>
<p>Your health care provider will give you the first of two medications and explain when and how you’ll take the second medication.</p>

<p>The first medication is called <b>mifepristone</b>. Mifepristone blocks the hormone <b>progesterone</b>. Because progesterone is necessary for pregnancy to continue, blocking it starts the process of ending the pregnancy. Mifepristone doesn’t usually cause any symptoms, so you probably won’t feel anything after you take it. Your provider will give you the second medication to take up to 48 hours later. <b>Make sure to follow the instructions</b> the provider gives you because they may differ from one provider to the next.</p>

<h3 style="font-size: 1.25rem; font-weight: 600;">Step 3: Take the second medication up to 48 hours later</h3>
<p>Up to 48 hours after taking mifepristone, you’ll take a dose (which is usually four tablets) of the second medication, called <b>misoprostol</b>.</p>

<p>For this step, you need to be somewhere you can relax and where you’ll have easy access to a bathroom. Misoprostol empties your uterus, expelling the pregnancy. It causes <b>cramping</b> and <b>bleeding</b>.</p>

<p>You may take one or more doses of misoprostol depending on how far along you are and how your body responds to the first dose—your provider will let you know. Misoprostol starts working about 30 minutes to a few hours after you take it. When it kicks in, it’s normal to experience bleeding. The bleeding could range from medium to very heavy. You will likely pass some blood clots. You’ll also likely have cramps, which can be severe. You may also experience <b>diarrhea</b> or <b>vomiting</b>.</p>

<p>You can take over-the-counter pain medication, or your health care provider may prescribe a prescription-strength pain medication. But after a few hours, the symptoms will usually pass. Bleeding will decrease over the next few days. You can go back to work, school, taking care of your kids, or your other normal activities the next day. You can have sex again as soon as you’re ready.</p>

<p>You should get your next period within <b>6 weeks</b> of having a medication abortion. If it’s been <b>8 weeks or more</b> since your abortion and you haven’t had a period, contact a health care provider.</p>

<p>Some health care providers will recommend a follow-up appointment a few weeks after your medication abortion to make sure the pregnancy is over. This appointment could take place via <b>telehealth</b>, a <b>phone call</b>, or <b>in person</b>, depending on the provider.</p>
`
}
,
    {
      id: "How much does an abortion with the abortion pill hurt?",
      title: "How much does an abortion with the abortion pill hurt?",
      content: `Just like with the abortion procedure, how much an abortion with the abortion pill hurts varies from person to person. The pain may last for several hours, as the abortion itself takes longer to be completed with the abortion pill than with the abortion procedure, which usually takes just a few minutes. You can take over-the-counter pain medications or your provider may prescribe pain medication for you to take at home. In addition to pain medicine, you may find that using a heating pad reduces pain. Other techniques like breathing exercises and meditation can also help with pain.

For more help deciding between the pill and the procedure, check out our list of pros and cons`
    },
  ]
};
