...
// ✅ Place the new useEffect here
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !articleContents[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(articleContents[cleanSlug]);
    };
    load();
  }, [slug]);
    ...
    <>
      <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="px-6 pt-6 pb-2">
          <Link to="/shw" className="text-[#058e8d] hover:underline text-sm font-medium">
             Sexual health  wellness &gt; Sexually Transmitted Infections (STDs, STIs)&gt;
          </Link>
        </div>
    ...
    {PFarticle.title}
        ...
        <div className="px-6 py-3">
          <div className="text-sm text-gray-500">
            <span className="font-medium text-[#058e8d]"> {PFarticle.author}</span>
        ...
        <div className="px-6 py-2">
          <svg viewBox="0 0 100 4" className="w-30 h-1" preserveAspectRatio="none">
