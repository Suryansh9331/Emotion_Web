...
const WhatServices = () => {
  ...
  const handleFindProvider = () => {
    navigate('/find-health-care/clinics');
  };

  const handleGetOnline = () => {
    navigate('/find-health-care/online-birth-control');
  };
      ...
      <div className="mx-auto px-6 max-w-full ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white border-3 border-[#8d2e8d] rounded-xl px-8 py-6 hover:shadow-md transition-all duration-200">
            ...
            <button 
              onClick={handleFindProvider}
              className="bg-[#028388] hover:bg-teal-600 text-white font-medium text-sm px-6 py-3 rounded-md transition-colors cursor-pointer duration-200"
            >
              find a provider
            </button>
          </div>
          ...
          <div className="bg-white border-3 border-[#c9005b] rounded-xl px-8 py-6 hover:shadow-md transition-all duration-200">
            ...
            <button 
              onClick={handleGetOnline}
              className="bg-[#028388] hover:bg-teal-600 text-white font-medium text-sm px-6 py-3 rounded-md transition-colors duration-200  cursor-pointer"
            >
              get it online
            </button>
          </div>
