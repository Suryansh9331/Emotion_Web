...
const RelatedArticles = () => {
  return (
    <div className="max-w-full mx-auto lg:px-24 px-6 py-8 bg-[#f5f5f5] min-h-screen">
      ...
      <div className="mb-8">
        <div className="mb-6">
          <h2 className="text-2xl md:text-5xl text-[#028388] font-bold mb-1">Birth control</h2>
          <div className="w-16 h-0.5 bg-[#028388]"></div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        {/* Article 1 */}
        <Link to="/birth-control/articles" className="block group">
          <div className="flex gap-4 bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition">
            <img src="/reproductive-health-supplies-coalition-bymICwLq-E4-unsplash.jpg" alt="img1" className="w-44 h-44 object-cover rounded-md" />
            <div className="flex-1">
              <p className="text-gray-400 text-xs uppercase tracking-wide mb-1">Related Articles</p>
              <h3 className="text-gray-800 font-medium text-sm md:text-base leading-tight group-hover:text-[#028388] transition-colors duration-200">
                20 ways over-the-counter pills are changing access and control
              </h3>
            </div>
          </div>
        ...
        <Link to="/birth-control/articles" className="block group">
          <div className="flex gap-4 bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition">
            <img src="/reproductive-health-supplies-coalition-cHrcHdg2H9E-unsplash (1).jpg" alt="img2" className="w-44 h-44 object-cover rounded-md" />
            <div className="flex-1">
              <p className="text-gray-400 text-xs uppercase tracking-wide mb-1">IUD</p>
              <h3 className="text-gray-800 font-medium text-sm md:text-base leading-tight group-hover:text-[#028388] transition-colors duration-200">
                How public voices are shaping awareness about IUD benefits.
        ...
        <Link to="/birth-control/articles" className="block group">
          <div className="flex gap-4 bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition">
            <img src="/230912_PTD_CapitolHill-04c.jpg" alt="img3" className="h-44 w-44 object-cover rounded-md" />
            <div className="flex-1">
              <p className="text-gray-400 text-xs uppercase tracking-wide mb-1">BIRTH CONTROL</p>
              <h3 className="text-gray-800 font-medium text-sm md:text-base leading-tight group-hover:text-[#028388] transition-colors duration-200">
                Why this year calls for more gratitude toward birth control options.
        ...
        <Link to="/birth-control/articles" className="block group">
          <div className="flex gap-4 bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition">
            <img src="/Screenshot 2024-03-04 at 8.04.06 AM (1).png" alt="img4" className="h-44 w-44 object-cover rounded-md" />
            <div className="flex-1">
              <p className="text-gray-400 text-xs uppercase tracking-wide mb-1">BIRTH CONTROL PILL</p>
              <h3 className="text-gray-800 font-medium text-sm md:text-base leading-tight group-hover:text-[#028388] transition-colors duration-200">
                A complete guide to Opill, the latest non-prescription birth control pill available.
      ...
      <div className="text-left">
        <Link
          ...
          className="inline-block bg-[#028388] hover:bg-teal-600 text-white px-6 py-3 rounded-lg font-medium transition-colors"
        >
