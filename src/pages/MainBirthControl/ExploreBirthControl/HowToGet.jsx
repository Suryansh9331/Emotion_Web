...
//           <div className="bg-white border-3 border-purple-500 rounded-xl px-8 py-6 hover:shadow-md transition-all duration-200">
//             {/* Small Purple Icon */}
...
//           <div className="bg-white border-3 border-pink-500 rounded-xl px-8 py-6 hover:shadow-md transition-all duration-200">
//             {/* Small Pink Icon */}
