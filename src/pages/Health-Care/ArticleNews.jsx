...
import { HCarticleContents } from "./data/articles";
...
//       const data = HCarticleContents[slug];
...
//       <Link to="/HCarticles" className="text-blue-500 hover:underline">&larr; Back to all articles</Link>
...
const HCArticleNews = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !HCarticleContents[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(HCarticleContents[cleanSlug]);
    };
    load();
  }, [slug]);
    ...
    <>
      <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="px-6 pt-6 pb-2">
          ...
          >
            Sexual health wellness &gt; Health-Care &gt; &gt;
          </Link>
        </div>
        {/* Article Title */}
