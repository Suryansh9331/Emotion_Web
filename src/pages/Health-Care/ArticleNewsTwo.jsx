...
import { HCarticleContentsTwo } from './data/articles';
import SubscriptionForm from '../../components/FriskyComponent';

// const HCArticleNewsTwo = () => {
//   const { slug } = useParams();
//   const [article, setArticle] = useState(null);

//   useEffect(() => {
//     const load = async () => {
//       const data = HCarticleContentsTwo[slug];
...
//         <Link to="/HCarticles-two" className="text-blue-500 hover:underline">
...
// export default HCArticleNewsTwo;
...
const handleFeedbackClick = (type) => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!cleanSlug || !HCarticleContentsTwo[cleanSlug]) {
        setPFArticle(null);
        return;
      }
      setPFArticle(HCarticleContentsTwo[cleanSlug]);
    };
    load();
  }, [slug]);
    ...
    <>
     <div className="max-w-4xl mx-auto bg-white">
        ...
        <div className="px-6 pt-6 pb-2">
          <Link to="/health-care" className="text-[#058e8d] hover:underline text-sm font-medium">
