...
import { Link } from 'react-router-dom';
import { HCarticlesTwo } from './data/articles';
...
const HCArticlesLayoutTwo = () => (
  <div className="min-h-screen bg-gray-50 py-8">
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="space-y-0">
        {HCarticlesTwo.map(article => (
          <Link
            key={article.slug}
            to={`/HCarticles-two/${article.slug}`}
          >
            <ArticleCard {...article} />
          </Link>
        ))}
...
export default HCArticlesLayoutTwo;
