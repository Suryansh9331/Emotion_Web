    ...
    <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      <div className="space-y-6">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          ...
          <p className="text-sm sm:text-base">
            Bedsiderr.org (Bedsiderr) is an online birth control support network for women 18-29 operated by{' '}
            <a 
              href="#" 
          ...
          <p className="text-sm sm:text-base">
            ...
            as unplanned. That sounds like a lot to us. We hope that Bedsiderr will be a useful tool for women to learn 
          ...
          <div className="space-y-2">
            <p className="text-sm sm:text-base">
              If you have any questions or concerns about Bedsiderr, you may contact us at:
            </p>
            
            <div className="pl-4 space-y-1">
              <p className="text-sm sm:text-base">
                <a 
                  href="mailto:info@Bedsiderr.org" 
                  className="text-blue-600 hover:text-blue-800 underline transition-colors duration-200"
                >
                  info@Bedsiderr.org
                </a>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm sm:text-base">
              ...
              Bedsiderr's main audience, and we thank them all for their guidance and insights. We are especially 
              grateful for the advice provided by Power to Decide's Health Care Advisory Committee. Even so, 
              responsibility for the content of Bedsiderr, including all medical information, rests solely with Power to 
              Decide itself.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <h2 className="text-base sm:text-lg font-medium text-gray-800">
              Bedsiderr.org is a nonprofit
            </h2>
            
            <p className="text-sm sm:text-base">
              Bedsiderr.org is operated by Power to Decide, a nonprofit, tax-exempt charitable organization (tax 
