    ...
    <div className="max-w-4xl mx-auto px-6 py-12 bg-white">
      <div className="space-y-8">
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          <p className="text-sm text-gray-600">Effective date May 20, 2020</p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                information. We may aggregate or de-identify the information described above. Aggregated or
        ...
        <section className="space-y-6">
          <h2 className="text-xl font-bold text-gray-900">How we use this information</h2>
          <p className="text-gray-700 leading-relaxed">
            We may use the information we collect about you in certain ways in connection with our business. These uses
            include:
          </p>
          <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
            <li>Providing you with the products and services you request;</li>
            ...
            <li>
              Performing business analyses or for other purposes to improve the quality of our business, and the
        ...
        <section className="space-y-6">
          <h2 className="text-xl font-bold text-gray-900">With whom we share this information</h2>
          <p className="text-gray-700 leading-relaxed">
            We may share the information we collect about you in limited circumstances, including:
          </p>
          <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
            <li>
              With our authorized service providers that perform certain functions or services on our behalf (such as to
              transmit communications or advertising, or assist with the transactions you initiate), although we require
            ...
            <li>
              ...
              affiliates, users, or the public;
            </li>
            <li>
              When we believe it is necessary to investigate, prevent, or take action regarding illegal activities,
              suspected fraud, or as otherwise required by law;
            </li>
            <li>
              To enforce our Terms of Use and other agreements, or otherwise protect or defend the rights or property of
              Power to Decide, its affiliates, or others, or the safety of the public;
            </li>
            <li>
              In connection with a corporate transaction, such as a divestiture, merger, consolidation, or asset sale;
            </li>
            <li>
              In aggregated or another non-personally identifiable form to third parties for various business purposes,
              including business analyses and advertising.
            </li>
          </ul>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section className="space-y-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            If you want to opt-out of Analytics for the web, visit the Google Analytics opt-out page and install the
            add-on for your browser. For more details on installing and uninstalling the add-on, please see the relevant
            help resources for your specific browser.
          </p>
          <p className="text-gray-700 leading-relaxed">
            The Google Analytics opt-out browser add-on does not prevent data from being sent to the website itself or
            in other ways to web analytics services.
          </p>
        </section>

        {/* How we protect your information */}
        <section className="space-y-6">
          <h2 className="text-xl font-bold text-gray-900">How we protect your information</h2>
          <p className="text-gray-700 leading-relaxed">
            We have implemented procedures to help protect the personal information that you provide to us. However, no
            method of transmitting or storing electronic data is ever completely secure, and we cannot guarantee that
            such information will never be accessed, used, or released in a manner that is inconsistent with this
            policy.
          </p>
        </section>
        ...
        <section className="space-y-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            We do not knowingly collect personal information from children under 13. Should we learn that a child under
            13 has provided us with personal information, we will delete that information from our database.
          </p>
        </section>

        {/* Public forums */}
        <section className="space-y-6">
          <h2 className="text-xl font-bold text-gray-900">A special word about public forums</h2>
          <p className="text-gray-700 leading-relaxed">
            Please keep in mind that whenever you voluntarily disclose personal information online in public forums,
            that information can be collected and used by others. This includes any information that you choose to make
            publicly available. For this reason, we encourage users not to post any sensitive information, including
            personal information, in any public forums.
          </p>
        </section>
        ...
        {/* Contact information */}
        <section className="space-y-6">
          <h2 className="text-xl font-bold text-gray-900">How you can contact us</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <footer className="border-t border-gray-200 pt-6 mt-12">
          <p className="text-sm text-gray-500">All rights reserved. Copyright © 2019. Power to Decide.</p>
        </footer>
      </div>
    </div>
