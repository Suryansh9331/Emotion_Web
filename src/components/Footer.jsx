        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/types/iud" className="text-gray-300 hover:text-white transition-colors duration-200">
                    Birth control
                  </Link>
                </li>
                {/* <li>
                  <a to="#" className="text-gray-300 hover:text-white transition-colors duration-200">
                    Abortion
                  </a>
                </li> */}
                <li>
                  <Link to="/sex-relationships/Relationships" className="text-gray-300 hover:text-white transition-colors duration-200">
                    Sex & relationships
                  </Link>
                </li>
                {/* <li>
                ...
                <li>
                  <Link to="/periods-and-vaginal-health" className="text-gray-300 hover:text-white transition-colors duration-200">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/health-center" className="text-gray-300 hover:text-white transition-colors duration-200">
                    Find a health care provider
                  </Link>
                </li>
                <li>
                   <a href='https://www.abortionfinder.org/' className="text-gray-300 hover:text-white transition-colors duration-200">
                    Find abortion care
                  </a>
                </li>
                {/* <li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/subscribe" className="text-gray-300 hover:text-white transition-colors duration-200">
                    Subscribe to Frisky Friday
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="https://powertodecide.org/donate" className="text-gray-300 hover:text-white transition-colors duration-200">
                    Donate
                  </a>
                </li>
                <li>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0">
            ...
            <div className="flex flex-wrap items-center gap-4 lg:gap-6 text-sm">
              ...
              <Link to="/privacy-policy" className="text-gray-700 hover:text-gray-900 transition-colors duration-200">
                Privacy policy
              </Link>
            </div>
            ...
            {/* Right Side - Power to Decide Logo */}
               <div className="flex items-center gap-6">
               <span className="text-sm text-gray-700 md:ml-4"></span>
               <img
                 src="/power-to-decide-2x-56e86515cb4dc42dd45101e5f325a99de1946d7c13e06ece8ecea93f1fb9f501.webp"
                 alt="Power to Decide logo"
                 width={120}
